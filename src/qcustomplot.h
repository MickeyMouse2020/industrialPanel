...
#else
#  include <QtNumeric>
//#  include <QtPrintSupport> //commented by fan 2019/12/5
#endif
...
class QCP_LIB_DECL QCPLayoutGrid : public QCPLayout
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
  Q_PROPERTY(int m_rowCount READ m_rowCount)
...
public:
  ...
  */
  ...
  //commented by fan 2019/12/5 cause:compatibility of winsock2.h with QCustomPlot  ,reference:https://www.qcustomplot.com/index.php/support/forum/644
